...
/******************************************************************************
 *
 * This class is copy of edu.princeton.cs.algs4.Draw with some extension
 *
 ******************************************************************************/
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // current dash parameters
    private float[] penDashArray = null;
    private float   penDashPhase = 0f;
    ...
    /**
     * Sets the dash of the pen to default
     */
     ...
     * @throws IllegalArgumentException if r is negative
     */
    public void setPenDash(float[] penDashArray, float penDashPhase) {

        this.penDashArray = penDashArray;
        this.penDashPhase = penDashPhase;
        BasicStroke stroke = null;
        if(penDashArray == null){
            stroke = new BasicStroke((float) penRadius, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
        } else {
            stroke = new BasicStroke((float) penRadius, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1.0f, penDashArray,penDashPhase);
        };
        offscreen.setStroke(stroke);
    }
    ...
    public void polyline(Point2D points[]) {
        for(int i = 0; i<points.length - 1; i++){
            this.line(points[i].getX(),points[i].getY(),points[i+1].getX(),points[i+1].getY());
        }
    }
