...
\begin{frame}{Polyline simplification}
	\begin{columns}
		\begin{column}{0.5\textwidth} 
			\begin{figure}[h]
				\center{\includegraphics[width=0.8\linewidth]{img/curve.eps}}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
...
\begin{frame}{Step by Step}
	\begin{figure}[h]
			\center{\includegraphics[width=1.\linewidth]{img/simple.eps}}
		\end{figure}
\end{frame}
...
\begin{frame}{Vectors}
		...
		\begin{figure}[h]
			\center{\includegraphics[width=0.5\linewidth]{img/vectors-1.eps}}
		\end{figure}
